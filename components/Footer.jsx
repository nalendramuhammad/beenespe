    ...
    <footer className='border-t-2 text-black bg-slate-50'>
      <div className='flex align-center justify-center'>
        <div className='max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center'>
          <div
            id='grid1'
            className='w-[85%] xl:border-none border-b-2 border-gray-600 pb-3'
          >
            <div className=''>
              <p
         ...
         items-center border border-slate-300 text-gray-200 hover:bg-orange-500'
              ...
              <p className='text-center'>theofficialmotorcycle</p>
            </div>
          </div>
          <div
            id='grid2'
      ...
      <div className='bg-black p-3'>
        <p className='text-center xl:text-base text-xs text-gray-300'>
          &copy; 2024 Motorcycle Company. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
